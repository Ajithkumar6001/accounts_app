import 'package:accounts_app/accountsapp_themes.dart';
import 'package:accounts_app/colors.dart';
import 'package:accounts_app/presentation/screens/auth/forgot_password_screen.dart';
import 'package:accounts_app/presentation/screens/user_profile/update_account_screen.dart';
import 'package:accounts_app/presentation/widgets/profile_tab.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ProfileTab(
                                  ...
                                  iconName: Icons.person,
                                  // titleValue: map['fullName']),
                                  titleValue: 'Ajithkumar'),
                              ProfileTab(
                                  constraints: constraints,
                                  title: 'Phone number',
                                  iconName: Icons.call,
                                  // titleValue: map['phoneNumber']),
                                  titleValue: '8300876372'),
                              ProfileTab(
                                  constraints: constraints,
                                  title: 'Bank account number',
                                  iconName: Icons.account_balance,
                                  // titleValue: map['bankAccNumber']),
                                  titleValue: '12345678986'),
                              ProfileTab(
                                  constraints: constraints,
                                  title: 'KYC number',
                                  iconName: Icons.person,
