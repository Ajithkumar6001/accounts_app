...
import 'package:accounts_app/presentation/screens/my_wallet/savings/automatic_investment_screen.dart';
import 'package:accounts_app/presentation/screens/my_wallet/savings/manual_investment_screen.dart';
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: SavingsCard(
                                        ...
                                        iconName: Icons.trending_up,
                                        title: 'Manual\ninvestment',
                                        verHeight: constraints.maxHeight * 0.2,
                                ...
                                StreamBuilder(
                                  ...
                                  builder: (context,
                                    ...
                                    if (snapshot.hasData) {
                                      ...
                                      // list.clear();
                                      // list = map.values.toList();
                                      // list.sort((a, b) => b['paymentDateTime']
                                      //     .compareTo(a['paymentDateTime']));
