...
import 'package:accounts_app/presentation/screens/home_screen/add_funds_screen.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:accounts_app/presentation/widgets/custom_card.dart';
            ...
            builder: ((context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
                if (snapshot.data.snapshot.value == null) {
                  ...
                  dynamic total = (map['needAvailableBalance'] ?? 0) +
                      (map['expensesAvailableBalance'] ?? 0) +
                      (map['savings'] ?? 0) as dynamic;
