import 'package:accounts_app/presentation/screens/plan/emergency_planning_screen.dart';
...
class _PlanningScreeenState extends State<PlanningScreeen> {
    ...
    return StreamBuilder<Object>(
        ...
        builder: (context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            ...
            bool isEFenabled = true;
            bool isCPenabled = true;
            dynamic targetEmergencyFunds = '5275';
            dynamic collectedEmergencyFunds = '2364';
            dynamic targetCarFunds = '7654';
            dynamic collectedCarFunds = '5643';
            return Scaffold(
              body: SafeArea(
                child: LayoutBuilder(
  ...
  Stack planningCard(textName, targetFunds, collectedFunds, comparetargetFunds,
      comparecollectedFunds) {
